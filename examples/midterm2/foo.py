...
def read_text_check1():
    """Check the output of the read_text() function (line 4) with sample.txt provided to students"""
...
def read_text_check2():
    """Check the output of the read_text() function (line 4) with sampletext2.txt not provided to students"""
...
def extract_values_check1():
    """Check the output of the extract_values() function for Expenses of Location1 with sample.txt provided to students"""
...
def extract_values_check2():
    """Check the output of the extract_values() function for Location2 with sample.txt provided to students"""
...
def extract_values_check3():
    """Check the output of the extract_values() function for Expenses of Location1 with sampletext2.txt not provided to students"""
...
def extract_values_check4():
    """Check the output of the extract_values() function for Location2 with sampletext2.txt not provided to students"""
